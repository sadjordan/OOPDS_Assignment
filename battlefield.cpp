...
Linked_List<Ship*>* Battlefield::Initial_Ship_Placement() {
...
void Battlefield::Ship_Placement(Ship* respawning_ship) {
    random_device rd;
    mt19937 gen(rd());
...
int* Battlefield::get_game_settings() const { return game_settings; }
int* Battlefield::get_TeamA() const { return TeamA; }
int* Battlefield::get_TeamB() const { return TeamB; }
char* Battlefield::get_TeamA_symbols() const { return TeamA_symbols; }
char* Battlefield::get_TeamB_symbols() const { return TeamB_symbols; }
string* Battlefield::get_TeamA_classes() const { return TeamA_classes; }
string* Battlefield::get_TeamB_classes() const { return TeamB_classes; }
char** Battlefield::get_game_map() const { return game_map; }
int Battlefield::getno_ships() const { return no_ships;}
int** Battlefield::get_symbol_map() const { return symbol_map; }